...
output <- read_authors(ecuador_references, 
                       filename_root="./output/ecuador")
...
output <- read_authors(ecuador2_references, 
                       filename_root="./output/ecuador2")
...
output <- read_authors(peru_references, 
                       filename_root="./output/peru")
...
```{r}
#eb_references <- read.csv("output/eb_references.csv", 
#                          as.is=TRUE)

#eb_authors <- read.csv("output/eb_authors.csv", 
#                       as.is=TRUE)

#eb_authors__references <- read.csv("output/eb_authors__references.csv", 
#                                   as.is=TRUE)
```
...
output <- remove_duplicates(authors=ecuador2_authors,
                            authors__references=ecuador2_authors__references,
...
output <- remove_duplicates(authors=peru_authors,
                            authors__references=peru_authors__references,
