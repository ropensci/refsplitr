...
```{r}
ecuador_no_dupes <- remove_duplicates(authors=ecuador_authors,
            authors_references=ecuador_authors_references,
            filename_root="output/ecuador_nodupe")
```

```{r}
ecuador2_no_dupes <- remove_duplicates(authors=ecuador2_authors,
                            authors_references=ecuador2_authors_references,
...
output <- merge_records(
	...
	authors__references=ecuador_authors_references, 
	references_merge=ecuador2_no_dupes$references, 
	authors_merge=ecuador2_no_dupes$authors, 
	authors__references_merge=ecuador2_no_dupes$authors_references,
