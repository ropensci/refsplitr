...
ecuador <- read_authors(ecuador_references,    filename_root="./output/ecuador")
```
...
ecuador_authors <- ecuador_no_dupes$authors
ecuador_authors_references <- ecuador_no_dupes$authors_references
...
ecuador2_authors <- ecuador2_no_dupes$authors
ecuador2_authors_references <- ecuador2_no_dupes$authors_references
```
