...
## I can't this one to work for me
eb_references <- read_references("~/refnet2/data/EBpubs.txt", dir=FALSE, filename_root="~/refnet2/output/eb")

# Biut this one does. 
eb_references <- read_references("./data/EBpubs.txt", dir=FALSE, filename_root="./output/eb")
# I think it's because the one above points to: '/Users/emiliobruna/refnet2/data/EBpubs.txt' and there is nothing there, whereas the second points to the local repo.


eb_authors <- read_authors(eb_references, filename_root="~/refnet2/output/eb")
...
LARR_references <- read_references("~/refnet2/data/LARR/", 
                                   dir=TRUE, 
       filename_root="~/refnet2/output/LARR")

LARR_authors <- read_authors(LARR_references, filename_root="~/refnet2/output/LARR")
