...
expect_error(references_read(data='./tests/extdata/BadHeader.txt' ,dir=F),
"ERROR:  The file ./tests/extdata/BadHeader.txt doesn't appear to be a valid ISI or\n          Thomson Reuters reference library file!")
d <- references_read(data='./tests/extdata/ISItop.txt' ,dir=F,
                     include_all=TRUE)
