...
df<-data.frame(
  address=c("Univ Sydney, Fac Vet Sci, Sch Life & Environm Sci, Sydney, NSW, Australia.",        
  ...
  "Univ Sao Paulo, Inst Biociencias, Dept Zool, BECO, Rua Matao,Trav 14 321, BR-05508090 Sao Paulo, Brazil.",
  "Univ Sydney, Charles Perkins Ctr, Sydney, NSW, Australia."),
  authorID=1:7,stringsAsFactors=F)
...
expect_equal(sum(grepl("[A-Z]{1}[0-9]{1}[A-Z]{1}\\s[0-9]{1}[A-Z]{1}[0-9]{1}", actual$postal_code)),2)
